            ...
            <div class="space-y-4 mt-4">
                <div class="space-y-1 flex flex-col">
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo htmlspecialchars($address['name'] ?? ''); ?>" 
                           id="name" 
                           class="bg-white px-2 text-sm rounded-md border <?php echo isset($errors['name']) ? 'border-red-500' : 'border-gray-300'; ?> h-10 placeholder:text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2">
                    <?php if (isset($errors['name'])): ?>
                        <span class="text-red-500 text-xs mt-1"><?php echo $errors['name']; ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="space-y-1 flex flex-col">
                    ...
                    <input type="email" 
                           ...
                           value="<?php echo htmlspecialchars($address['email'] ?? ''); ?>" 
                           id="email" 
                           class="bg-white px-2 text-sm rounded-md border <?php echo isset($errors['email']) ? 'border-red-500' : 'border-gray-300'; ?> h-10 placeholder:text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2">
                    <?php if (isset($errors['email'])): ?>
                        <span class="text-red-500 text-xs mt-1"><?php echo $errors['email']; ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="space-y-1 flex flex-col">
                    ...
                    <input type="text" 
                           ...
                           id="address" 
                           class="bg-white px-2 text-sm rounded-md border <?php echo isset($errors['address']) ? 'border-red-500' : 'border-gray-300'; ?> h-10 placeholder:text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2">
                    <?php if (isset($errors['address'])): ?>
                        <span class="text-red-500 text-xs mt-1"><?php echo $errors['address']; ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1 flex flex-col">
                        ...
                        <input type="text" 
                               ...
                               id="city" 
                               class="bg-white px-2 text-sm rounded-md border <?php echo isset($errors['city']) ? 'border-red-500' : 'border-gray-300'; ?> h-10 placeholder:text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2">
                        <?php if (isset($errors['city'])): ?>
                            <span class="text-red-500 text-xs mt-1"><?php echo $errors['city']; ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="space-y-1 flex flex-col">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo htmlspecialchars($address['post_code'] ?? ''); ?>" 
                               id="postal-code" 
                               class="bg-white px-2 text-sm rounded-md border <?php echo isset($errors['post_code']) ? 'border-red-500' : 'border-gray-300'; ?> h-10 placeholder:text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2">
                        <?php if (isset($errors['post_code'])): ?>
                            <span class="text-red-500 text-xs mt-1"><?php echo $errors['post_code']; ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
